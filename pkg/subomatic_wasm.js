/* @ts-self-types="./subomatic_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function sync_to_audio(input, format, samples, sample_rate, fps, out_format, vad, on_progress) {
    let deferred7_0;
    let deferred7_1;
    try {
        ...
        const ptr3 = passStringToWasm0(out_format, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passStringToWasm0(vad, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len4 = WASM_VECTOR_LEN;
        const ret = wasm.sync_to_audio(ptr0, len0, ptr1, len1, ptr2, len2, sample_rate, fps, ptr3, len3, ptr4, len4, on_progress);
        var ptr6 = ret[0];
        var len6 = ret[1];
        if (ret[3]) {
            ptr6 = 0; len6 = 0;
 ...
 * @param {string} input
 * @param {string} format
 * @param {string} reference_text
 * @param {string} reference_format
 * @param {number} fps
 * @param {string} out_format
 * @param {Function} on_progress
 * @returns {string}
 */
export function sync_to_reference(input, format, reference_text, reference_format, fps, out_format, on_progress) {
    let deferred7_0;
    let deferred7_1;
    try {
        const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ptr1 = passStringToWasm0(format, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(reference_text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(reference_format, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passStringToWasm0(out_format, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len4 = WASM_VECTOR_LEN;
        const ret = wasm.sync_to_reference(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, fps, ptr4, len4, on_progress);
        var ptr6 = ret[0];
        var len6 = ret[1];
        if (ret[3]) {
            ptr6 = 0; len6 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('subomatic_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
